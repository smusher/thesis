...
An additional assumption of noise analysis as described is that all current fluctuations can be observed, and thus the calculated variance accurately captures the true variance.
If 
