...
To determine the extent to which crosstalk between neighbouring subunits would affect the measure FRET efficiency when ANAP is incorporated at position 311, we simulated the expected FRET for a single K\ATP{} channel bound to 0-4 molecules of TNP-ATP in an idealised scenario with no crosstalk, and compared the observed fluorescence quenching to a scenario including the possibility of crosstalk (Figure \ref{ch3fig:exifret_out}).
