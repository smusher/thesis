...
\begin{figure}[h]
	...
	\caption[Electrical excitability of pancreatic beta cells]{
		...
		\subref{ch1fig:beta_cells_firing} Current record of a cell-attached patch of an isolated pancreatic beta cell, reproduced from \cite{rorsman_calcium_1986}. 
...
\begin{figure}[h]
	...
	\caption[Structure of Kir6.2]{
		...
		\subref{ch1fig:shyng_trace} Macroscopic currents from Kir6.2 channels coexpressed with SUR1 in excised patches from cultured cells, adapted from \cite{pratt_n-terminal_2011}.
