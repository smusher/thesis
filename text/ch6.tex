...
\begin{figure}[h]
	...
	\subref{ch6fig:tmd0s_surface_expression_2}, \subref{ch6fig:tmd0s_surface_expression_3} Contrasts between WT-GFP (\subref{ch6fig:tmd0s_surface_expression_2}) or W311*-GFP (\subref{ch6fig:tmd0s_surface_expression_3}) surface expression when coexpressed with SUR1, TMD0 or TMD0-L0 and WT-GFP alone.
