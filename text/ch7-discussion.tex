...
\begin{figure}[h]
	...
	\subref{ch7fig:activation_fit_1} Fluorescence quenching (blue) and current regulation (orange) of G334D+SUR1-T1397* by MgTNP-ADP (left) or W311*-GFP+SUR1 by TNP-ATP (right).
	...
	\subref{ch4fig:w311_mwc_fit_3} Posterior probability distributions for each of the five free parameters estimated from fits to the MWC model are shown shaded according to their credible intervals.
...
\section{Nucleotide inhibition in the context of other ligand-gated ion channels}
