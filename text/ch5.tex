...
\begin{figure}[h]
	...
	\subref{ch5fig:l_d_sim_1}, \subref{ch5fig:l_d_sim_2} Simulated data from the MWC model with $K_A$ fixed to $10^{-4}$ and $L$ and $D_A$ varied as described in the legend.
...
The free energy TNP-ATP binding contributes to the closed stated of W311*-GFP+SUR1 is \SIrange{23.0}{63.4}{\kilo\joule\per\Molar}, while the free energy TNP-ATP binding contributes to the closed state of W311*,C166S-GFP+SUR1 is only \SIrange{20.4}{-3.05}{\kilo\joule\per\Molar}.
