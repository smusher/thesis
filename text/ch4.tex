...
\begin{figure}[hbtp]
	...
	Fitted curves are the median (line) and \SI{95}{\percent} credible intervals (shaded area) of the posterior probability distribution of fits to the MWC model parameterised in equations \ref{eq:mwc_binding} and \ref{eq:normalised_po}, not including the $\delta_{experiment}$.
	...
	\subref{ch4fig:w311_single_fit_1} Data the same as \subref{ch4fig:w311_mwc_fit_1}, but the fitted curves are the median (line) and \SI{95}{\percent} credible intervals (shaded area) of the posterior probability distribution of fits to the single binding model parameterised in equations \ref{eq:single_binding} and \ref{eq:single_gating}, not including the $\delta_{experiment}$.
