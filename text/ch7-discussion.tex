...
The difficulty of obtaining open states of \mccorrect{Kir channels in particular} means that relating the captured structures to the function of K\ATP{} is not trivial, and many open questions remain \cite{puljung_cryo-electron_2018}.
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{Modes of regulation of K\ATP{} - reprinted.}}
...
Comparison of the binding association constants for TNP-nucleotides at Kir6.2 and NBS2 shows that MgTNP-ADP binds \mccorrect{with a higher affinity} to NBS2 than TNP-ATP binds to Kir6.2 (Figure \ref{ch7fig:activation_params_1}).
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{TNP-ATP inhibits K\ATP{} channels more strongly than MgTNP-ADP activates them.}}
...
While K\ATP{} channels are inhibited by intracellular ATP, the P2X receptor family are \mccorrect{activated} by extracellular ATP, and differences in the ATP concentrations and dynamics in these two spaces suggest there may be other biophysical differences in nucleotide regulation, upon which direct measurements of nucleotide binding may be able to shed light \cite{mansoor_x-ray_2016}.
