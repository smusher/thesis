...
Essentially, the $EC_{50}$ parameter was fit with a population parameter (\textgreek{b}) and an additional 'random' component that varied between experiments (\textgreek{d}\textsubscript{experiment}).
