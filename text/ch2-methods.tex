...
\begin{figure}
	...
	\caption[Flipping a coin - illustrating Bayesian analysis]{
		{\bf\mccorrect{Flipping a coin - illustrating Bayesian analysis.}}
...
\begin{figure}
	...
	\caption[Credible intervals of a probability distribution]{
		{\bf\mccorrect{Credible intervals of a probability distribution.}}
...
\begin{figure}
	...
	\caption[Multilevel modelling of coinflips]{
		{\bf\mccorrect{Multilevel modelling of coinflips.}}
...
\begin{figure}
	...
	\caption[Multilevel modelling of coinflips - fitting the model]{
		{\bf\mccorrect{Multilevel modelling of coinflips - fitting the model.}}
...
Cross-validation is a procedure which attempts to estimate the ability of a model to make predictions on data which were not used to fit the model.
