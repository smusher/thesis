...
\usepackage[style=nature, sorting=none, backend=biber, doi=false, isbn=false, url=false, eprint=false]{biblatex}
...
\addbibresource{text/ref_gen_210705.bib}
...
\title{Regulation of K\textsubscript{ATP} channel activity}
\author{Samuel Usher}
...
\include{text/ch2-methods}
\include{text/ch3}
\include{text/ch4}
\include{text/ch5}
\include{text/ch6}
\include{text/ch7-discussion}
