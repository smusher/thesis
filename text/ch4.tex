...
Another aim is more holistic; hoping that increasing our understanding of how the K\ATP{} channel is regulated by the interplay of its ligands may shed light on other ion channels or proteins functions \cite{garfinkel_modeling_2017}.
...
\begin{figure}[h]
	...
	\subref{ch4fig:w311_states_weights_1}, \subref{ch4fig:w311_states_weights_2} Weighted occupancy of the different states of W311*-GFP+SUR1 predicted by the MWC fits to the data in Figure \ref{ch4fig:w311_model_comparison} as the concentration of TNP-ATP increases.
