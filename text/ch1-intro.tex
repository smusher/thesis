...
\begin{figure}[h]
	...
	\caption[Electrical excitability of pancreatic beta cells]{
		...
		\subref{ch1fig:beta_cells_firing} Current record of a cell-attached patch of an isolated pancreatic beta cell, reproduced from \cite{rorsman_glucose_1985-1} and reversed. 
