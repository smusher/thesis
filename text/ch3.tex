...
\begin{figure}[hbtp]
	...
	\caption[ANAP and TNP-nucleotides as FRET pairs]{
		{\bf\mccorrect{ANAP and TNP-nucleotides as FRET pairs.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{TNP-ATP is predicted to bind with a similar pose to ATP.}}
...
We ended up with one residue which fulfilled these criteria and for which surface membrane expression of the ANAP-incorporated channel could be detected: W311 \mccorrect{(Figure {\ref{ch3fig:w311_loc}})}.
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.9\textwidth]{w311_loc_1.pdf}
	\caption[Location of residue W311 in Kir6.2]{
	{\bf{Location of residue W311 in Kir6.2.}}
	Residue W311 is shown in purple in the cryo-EM structure of K\ATP{} (PDB \#6C3P), with all four Kir6.2 and TMD0 and L0 of two SUR1 subunits shown.
...
However, in this study \textit{Xenopus} oocytes were the heterologous expression system, so rather than transfecting a combination of plasmids, the authors injected a combination of transcribed mRNAs \mccorrect{plus synthetic aminoacylated tRNA}.
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{ANAP incorporation.}}
	\subref{ch3fig:amber_codon} ANAP incorporation is accomplished through the transfection of two plasmids.
	pANAP codes for tRNA (red) and \mccorrect{its} tRNA synthetase (green), while W311TAG codes for Kir6.2 with an Amber stop codon (TAG) inserted in place of the codon for W311 (grey).
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{ANAP construct surface expression assay.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{WT-GFP and W311*-GFP electrophysiology.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{Unroofed membranes spectral images.}}
	\subref{ch3fig:unroofed_images} An unroofed membrane patch imaged either with brightfield illumination (top), GFP fluorescence (middle) or ANAP fluorescence (bottom).
	...
	\subref{ch3fig:unroofed_intensities} Bleaching-corrected ANAP fluorescence intensities of the spectral traces in \subref{ch3fig:unroofed_spectral_images} expressed as the average fluorescence of the ANAP peak divided by the average fluorescence of the ANAP peak in $0$ TNP-ATP, or $F/F_{max}$.
	}
\end{figure}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{Unroofed membranes bleaching correction.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{Numerical analysis of FRET efficiency in tetrameric Kir6.2.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{W311*-GFP unroofed membrane binding.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{PCF bleaching correction.}}
...
\begin{figure}[hbtp]
	...
	{\bf\mccorrect{ANAP is not quenched by ATP.}}
